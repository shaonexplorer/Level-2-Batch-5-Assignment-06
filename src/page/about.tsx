...
import about01 from "../assets/about-1.jpg";
...
const AboutPage = ({
  title = "About Us",
  description = "A fast paced organization, the company gives it employees an immense amount of space to grow professionally as well as take ownership of the initiatives undertaken in the organization.",
  mainImage = {
    src: about,
    alt: "placeholder",
  },
            ...
            {companies.map((company, idx) => (
              <div className="flex items-center gap-3" key={company.src + idx}>
                <img
                  src={company.src}
                  alt={company.alt}
                  className="h-6 w-auto md:h-8 dark:invert-100"
                />
              </div>
            ))}
          </div>
